...
import 'provider_map_screen.dart'; // ✅ Thêm bản đồ
...
class _ProviderHomeScreenState extends State<ProviderHomeScreen> {
  ...
  void _goToChat() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ProviderChatListScreen(token: widget.token),
      ),
    );
  }
  ...
  Widget _buildBody() {
    switch (_selectedIndex) {
      ...
      case 1:
        return ProviderMapScreen(token: widget.token);
      case 2:
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.home_repair_service), label: 'Dịch vụ'),
